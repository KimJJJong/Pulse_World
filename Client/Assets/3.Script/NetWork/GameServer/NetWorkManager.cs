...
//        if (packet == null)
//        {
//            Debug.LogError("[NetWorkManager] Send(IPacket) packet is NULL");
//            return;
//        }

//        if (_state != ConnState.Connected)
//        {
//            Debug.LogWarning($"[NetWorkManager] Send ignored. state={_state}");
//            return;
//        }

//        try
//        {
//            var seg = packet.Write(); // ✅ 여기서 NRE 나는지 확인 가능
//            _session.Send(seg);
//        }
//        catch (Exception ex)
//        {
//            Debug.LogError($"[NetWorkManager] packet.Write()/Send failed: {ex}");
//        }
//    }
