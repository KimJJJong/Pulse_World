public static partial class ActionRequestTranslator
{
    ...
    static bool TryBuildMove(int actorId, CS_ActionRequest req, long executeBeat, int judgeDiffMs, long serverReceiveMs,
    ...
    static bool TryBuildAttack(int actorId, CS_ActionRequest req, long executeBeat, int judgeDiffMs, long serverReceiveMs,
        out PlayerActionCmd cmd, out string reason)
    {
        reason = "";
    ...
    static bool TryBuildSkill(int actorId, CS_ActionRequest req, long executeBeat, int judgeDiffMs, long serverReceiveMs,
        out PlayerActionCmd cmd, out string reason)
    {
        reason = "";
